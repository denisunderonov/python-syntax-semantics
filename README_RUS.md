...
4. [Глава IV](#глава-iv) \
    4.1. [Упражнение 00. Типы данных](#упражнение-00-типы-данных)
5. [Глава V](#глава-v) \
    5.1. [Упражнение 01. Работа с файлами](#упражнение-01-работа-с-файлами)
6. [Глава VI](#глава-vi) \
    6.1. [Упражнение 02. Поиск по ключу](#упражнение-02-поиск-по-ключу)
7. [Глава VII](#глава-vii) \
    7.1. [Упражнение 03. Поиск по значению и по ключу](#упражнение-03-поиск-по-значению-и-по-ключу)
8. [Глава VIII](#глава-viii) \
    8.1. [Упражнение 04. Словари](#упражнение-04-словари)
9. [Глава IX](#глава-ix) \
    9.1. [Упражнение 05. Поиск по значению или по ключу](#упражнение-05-поиск-по-значению-или-по-ключу)
10. [Глава X](#глава-x) \
    10.1. [Упражнение 06. Сортировка словаря](#упражнение-06-сортировка-словаря)
11. [Глава XI](#глава-xi) \
    11.1. [Упражнение 07. Множества](#упражнение-07-множества)
12. [Глава XII](#глава-xii) \
    12.1. [Упражнение 08. Работа со строками как со списками](#упражнение-08-работа-со-строками-как-со-списками)
13. [Глава XIII](#глава-xiii) \
    13.1. [Упражнение 09. Шифр Цезаря](#упражнение-09-шифр-цезаря)
...
1. Создай скрипт data_types.py и определи функцию data_types(). В этой функции объяви 8 переменных разных типов и выведи их типы в стандартный поток вывода.
...
1. Разработай скрипт на Python read_and_write.py, который открывает файл ds.csv, считывает содержащиеся в нём данные, заменяет все разделители-запятые на "\t" и сохраняет данные в новый файл ds.tsv. Будь внимателен: в данных могут встречаться запятые. Если ты заменишь их, данные будут повреждены.
...
1. Создай скрипт с именем to_dictionary.py. В одной из функций скопируй следующий список кортежей как есть:
...
1. Составить список участников, которые не являются твоими клиентами. Отправь им вводное письмо, в котором содержится информация о твоих продуктах продуктах.
1. Составить список клиентов, которые не участвовали в мероприятии. Отправь им ссылку на видео и слайды презентации с мероприятия.
...
Представь, что ты работаешь в корпорации, где все почтовые адреса имеют единый шаблон: <name.surname@corp.com>.
...
2. Создай другой скрипт, который принимает адрес электронной почты, ищет соответствующее имя в файле, созданном первым скриптом, и возвращает первый абзац письма:
    _Иван, добро пожаловать в нашу команду! Мы уверены, что работать вместе с тобой будет очень приятно. Для нас это важно - мы стремимся, чтобы в компании работались именно такие люди._
3. Использовать конструкцию `'la-la {0}'.format(text)` запрещено. Пожалуйста, используй f-строки. Они быстрее и читается лучше.
